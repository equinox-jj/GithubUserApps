...
class FollowerViewModel : ViewModel() {
    ...
    val followerUser = MutableLiveData<List<SearchItems>>()
    val isLoading = MutableLiveData<Boolean>()
    val isError = MutableLiveData<Boolean>()

    fun followerUserList(followerQuery: String) {
        isLoading.value = true
        disposable.add(
            apiConfig.getFollowers(followerQuery)
